...
starObj.prototype.init = function() {
	this.x = Math.random() * skyWidth + padLeft;
	this.y = Math.random() * skyHeight + padTop;
...
starObj.prototype.update = function() {
	...
	if (this.x > (padLeft + skyWidth) || this.x < (padLeft - 10))
		this.init();
	else if (this.y > (padTop + skyHeight) || this.y < (padTop - 10))
		this.init();
