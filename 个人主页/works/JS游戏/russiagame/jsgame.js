...
Time.prototype.get_ticks = function() {
	return(new Date).getTime() - this.init_time
};
...
Time.prototype.tick = function() {
	var a = (new Date).getTime(),
		b = a - this.last_update;
	this.last_update = a;
	return b
};
Time.prototype.fps = function(a) {
	this.wait(1E3 / a)
};
Time.prototype.lock = function() {
	this.waiting = true
};
Time.prototype.unlock = function() {
	this.waiting = false
};
	...
	switch(arguments.length) {
		case 1:
			...
			if(arguments[0] instanceof HTMLImageElement) {
				...
				this.ctx = this.canvas.getContext("2d");
				this.ctx.drawImage(arguments[0], 0,
...
Surface.prototype.draw = function(a, b, c) {
	this.ctx.drawImage(a.canvas, b, c)
};
Surface.prototype.get_pixel = function(a, b) {
	var c = this.ctx.getImageData(0, 0, this.width, this.height).data,
		d = (b * this.width + a) * 4;
	return [c[d + 0], c[d + 1], c[d + 2], c[d + 3]]
};
Surface.prototype.set_pixel = function(a, b, c) {
...
Surface.prototype.subsurface = function(a, b, c, d) {
	var e = new Surface(c, d);
	e.ctx.drawImage(this.canvas, a, b, c, d, 0, 0, c, d);
	return e
};
Surface.prototype.save = function() {
	this.ctx.save()
};
Surface.prototype.scale = function(a, b) {
	this.ctx.scale(a, b)
};
Surface.prototype.translate = function(a, b) {
	this.ctx.translate(a, b)
};
Surface.prototype.restore = function() {
	this.ctx.restore()
};
Surface.prototype.strokeStyle = function(a) {
	this.ctx.strokeStyle = a
};
Surface.prototype.beginPath = function() {
	this.ctx.beginPath()
};
Surface.prototype.line = function(a, b, c, d) {
	this.ctx.moveTo(a, b);
	this.ctx.lineTo(c, d)
};
Surface.prototype.stroke = function() {
	this.ctx.stroke()
};
...
Surface.prototype.fillRect = function(a, b, c, d, e) {
...
Font.prototype.render = function(a, b, c, d) {
	...
	var g = "";
	if(this.bold) g += "bold ";
	if(this.italic) g += "italic ";
	g = g + e.toString() + "px " + this.name;
	i.font = g;
	i.fillText(a, 0, 0);
	f = d.ctx.getImageData(0, 0, h, f);
	h = 0;
	g = 1E4;
